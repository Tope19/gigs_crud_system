...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2021 at 03:06 PM
...
(2, 'Krystal Digital', '2021-04-17 11:08:38', '2021-04-19 01:21:24');
...
CREATE TABLE `gigs` (
  ...
  `employment_type` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `min_wage` double NOT NULL,
  `max_wage` double NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `gigs` (`id`, `company_id`, `role`, `country_id`, `state_id`, `address`, `employment_type`, `min_wage`, `max_wage`, `created_at`, `updated_at`) VALUES
(2, 2, 'Backend Engineer', 160, 2671, 'No 7 Gbolahan Adetoro Close', 'fulltime', 150000, 180000, '2021-04-19 11:22:07', '2021-04-19 11:23:28');
...
(8, '2020_03_13_083515_add_description_to_tags_table', 1),
(9, '2021_04_17_093739_create_companies_table', 1),
(14, '2021_04_17_094151_create_gigs_table', 2);
...
(1, 'Tope Olotu', 'topeolotu75@gmail.com', NULL, '$2y$10$0ZwNOHFESmn5w9XTkHc6mec9VeoRl19rk4m6DG0as1d4koDr0tlNW', NULL, '2021-04-17 09:30:07', '2021-04-17 09:30:07');
...
ALTER TABLE `gigs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `gigs_company_id_foreign` (`company_id`);
...
--
ALTER TABLE `gigs`
  ADD CONSTRAINT `gigs_company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE;
